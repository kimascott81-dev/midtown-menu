...
<style>
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  @media (max-width: 500px) {
    ...
    .home-card { min-height: 110px; flex-direction: row; gap: 16px; padding: 18px 24px; text-align: left; }
  ...
  .card-emoji { font-size: 2.4rem; display: block; margin-bottom: 6px; }
...
<div id="app">
  ...
  <main>
    ...
    <div id="view-home" class="view active">
      ...
      <div class="home-grid">
        <button class="home-card" onclick="showView('browse')">
        ...
        <button class="home-card" onclick="showView('inventory')">
        ...
        <button class="home-card" onclick="startCreate()">
        ...
        <button class="home-card" onclick="showView('myrecipes')">
...
function showView(name) {
  // alert('Switching to: ' + name); // Uncomment this line to test if clicks work
